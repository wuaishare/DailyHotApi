...
const SUBTYPE_CONFIG = {
  "models-week": {
    kind: "models",
    url: "https://openrouter.ai/api/frontend/rankings/models?view=week",
    typeLabel: "模型周度热度榜",
  },
  "market-share": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/market-share",
    typeLabel: "厂商市场份额周榜",
  },
  performance: {
    kind: "performance",
    url: "https://openrouter.ai/api/frontend/rankings/performance",
    typeLabel: "模型性能 / 吞吐榜",
  },
  tools: {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/tools",
    typeLabel: "工具调用模型榜",
  },
  images: {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/images",
    typeLabel: "多模态输入模型榜",
  },
  "image-output": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/image-output",
    typeLabel: "图像生成模型榜",
  },
  "apps-week": {
    kind: "apps",
    url: "https://openrouter.ai/api/frontend/rankings/apps",
    typeLabel: "AI 应用周榜",
    period: "week",
  },
  "apps-day": {
  ...
  "benchmarks-aa-intelligence": {
    kind: "benchmarks",
    url: "https://openrouter.ai/api/frontend/rankings/benchmarks",
    typeLabel: "AA 智能基准榜",
    seriesKey: "intelligence",
  },
  "use-case-programming": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/use-case-category?category=programming",
    typeLabel: "编程场景模型榜",
  },
  "natural-language-english": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/natural-language?tag=English",
    typeLabel: "英文场景模型榜",
  },
  "programming-language-python": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/programming-language?tag=Python",
    typeLabel: "Python 场景模型榜",
  },
  "context-length-10k": {
    kind: "series",
    url: "https://openrouter.ai/api/frontend/rankings/context-length?bucket=10K",
